...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: "ABOUT US", href: "/about-us" },
  {
    ...
    href: "/inventory",
    children: [
      { label: "Cables", href: "/inventory" },
      { label: "Valves", href: "/inventory" },
      { label: "Pipes", href: "/inventory" },
      { label: "Pipe Fittings & Flanges", href: "/inventory" },
      { label: "Fasteners", href: "/inventory" },
      { label: "E & I Material", href: "/inventory" },
      { label: "Gaskets", href: "/inventory" },
      { label: "Structural Material", href: "/inventory" },
      { label: "Plates, Sheets, Coils", href: "/inventory" },
    ],
  },
      ...
      <div className="container mx-auto py-1">
        <div className="flex h-20 items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-3 select-none">
            <Image src="/logo2.png" width={250} height={90} alt="ScrapWorld" priority className="w-[150px] md:w-[250px] h-auto drop-shadow rounded-lg" />
