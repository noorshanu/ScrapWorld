...
const Banner: React.FC = () => {
  return (
    <section aria-label="Contact banner" className="relative w-full overflow-hidden">
      <div className="relative h-[32vh] sm:h-[42vh] md:h-[52vh]">
        <Image
          src="/contact-banner.jpg"
          alt="Contact Scrap World background"
          fill
          priority
        ...
        <div className="absolute inset-0 flex items-center">
          <div className="container mx-auto px-4">
            ...
            >
              Reach our team for quotes, availability and export timelines.
            </motion.p>
          </div>
        </div>
      </div>
